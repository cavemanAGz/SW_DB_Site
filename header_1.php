        ...
        <div class="container">                
            ...
            <div class="navbar-collapse collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="index.php">@UO-SWDB*</a></li>
                    <li><a href="Characters.php">Characters</a></li>
                    <li><a href="Vehicles.php">Vehicles</a></li>
                    <li><a href="Planets.php">Planets</a></li>
                    <li><a href="Species.php">Species</a></li>
                    <li><a href="Organization.php">Organizations</a></li>
                    <li><a href="Adversaries.php">Adversarial Groups</a></li>
                    <li><a href="Char_Org.php">Organization Memberships</a></li>
                    <li><a href="Char_Vehic.php">Vehicle Ownership</a></li>
                    <li><a href="Char_Spec.php">Character SPecies</a></li>
                </ul>
            </div>
        </div>            
    </nav>
